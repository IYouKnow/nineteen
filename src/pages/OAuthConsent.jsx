...
// Simple replacement for AuthLayout - a container with icon, title, and content
function AuthLayoutPlaceholder({ icon: Icon, title, subtitle, footer, children }) {
  return (
...
export default function OAuthConsent() {
  ...
  if (checking) {
    return (
      <AuthLayoutPlaceholder icon={ShieldCheck} title="Authorize access">
  ...
  if (reconnect) {
    return (
      <AuthLayoutPlaceholder icon={ShieldCheck} title="Reconnect required">
